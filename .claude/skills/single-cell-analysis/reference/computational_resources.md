...
- Doublet detection: 600,000 ms (10 minutes)
...
- ✅ Perform proper QC (doublet detection, filtering)
...
- "Doublet detection takes time" - NOT an excuse
...
| Doublet detection | 5-8 min | 10 min |
...
**Therefore:**
- No excuses for skipping QC, doublet removal, or batch correction
