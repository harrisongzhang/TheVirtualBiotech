...
register_tool(mcp, get_census_info)
register_tool(mcp, list_metadata_values)
register_tool(mcp, search_genes)
register_tool(mcp, query_cell_metadata)
register_tool(mcp, get_anndata)

# Register Tier 2 tools - Query Planning & Statistics
register_tool(mcp, count_cells)
register_tool(mcp, get_gene_statistics)
register_tool(mcp, summarize_datasets)

# Register Tier 3 tools - Advanced/Specialized
register_tool(mcp, get_cell_type_tissue_matrix)
register_tool(mcp, get_expression_for_genes)
register_tool(mcp, get_anndata_donor_balanced)
